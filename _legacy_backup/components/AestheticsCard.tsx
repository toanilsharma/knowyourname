...
export const AestheticsCard: React.FC<Props> = ({ analysis }) => {
    ...
    // Create the Simner Gradient
    const gradientString = `linear-gradient(to right, ${synesthesia.colors.join(', ')})`;
            ...
            <div className="space-y-10">
                ...
                <div className="relative group">
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                        <span className="font-bold text-purple-600 dark:text-purple-400">Rare Sunset Gradient.</span> Most names are muddy brown. Yours possesses a distinct distinct {analysis.synesthesia.colors[0] === '#ef4444' ? 'Red' : 'Blue'} dominant hue based on scientifically mapped letter-color synesthesia.
                    </p>
                </div>
