        ...
        <div className="min-h-screen bg-white dark:bg-slate-950 pt-16 pb-24">
            ...
            <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose dark:prose-invert prose-slate lg:prose-lg">
                ...
                <section>
                    ...
                    <ul>
                        <li><strong>Analysis Engine:</strong> The core <code>nameAnalysisEngine.ts</code> is reviewed and updated as new research becomes available. Major version updates are logged in the "Engine v7.5" changelog (see <Link to="/methods">Methods page</Link>).</li>
                        <li><strong>Literature Reviews:</strong> Our <Link to="/research">Research Library</Link> articles are reviewed annually to incorporate new findings and meta-analyses.</li>
