...
export const BoubaKiki: React.FC = () => {
            ...
            <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <nav className="mb-8 text-sm animate-fade-in-up">
                    <div className="flex items-center gap-2 text-slate-500">
                        ...
                        <span>/</span>
                        <Link to="/research" className="hover:text-blue-600 transition-colors">Research</Link>
                        <span>/</span>
                ...
                <div className="mt-16 flex justify-between items-center pt-8 border-t border-slate-200 dark:border-slate-800">
                    <Link to="/research/sound-symbolism" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">
                        ← Sound Symbolism
                    </Link>
                    <Link to="/research/phonotactics" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">
                        Phonotactics →
                    </Link>
                </div>
            </article>
