            ...
            {!analysis && !compatibility ? (
                <div className="relative z-10 flex flex-col items-center animate-fade-in-up pt-10 md:pt-20 px-4">
                    ...
                    <div className="w-full max-w-5xl mx-auto text-center mb-16">
                        ...
                        {/* Premium Badge */}
                        <div className="inline-flex items-center gap-3 px-6 py-2 mt-6 bg-gradient-to-r from-amber-500/10 via-amber-500/20 to-amber-500/10 text-amber-700 dark:text-amber-400 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] mb-8 border border-amber-500/30 backdrop-blur-md shadow-lg shadow-amber-500/5">
                            ...
                            <span>Linguistic Engine v7.5</span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 font-light max-w-3xl mx-auto leading-relaxed mb-8 relative z-20">
                        ...
                        <div className="relative w-full max-w-xl mx-auto mb-8">
                            <div className="absolute inset-0 bg-gradient-to-r from-slate-50 via-transparent to-slate-50 dark:from-slate-950 dark:to-slate-950 z-10"></div>
                            <img 
                                src="/images/name-dna.png" 
                                alt="Name DNA visualization"
                                className="w-full h-32 object-cover rounded-2xl opacity-80 dark:opacity-60"
                            />
                        </div>
                    ...
                    <div id="analysis-container" className="p-8 -m-8 rounded-3xl bg-slate-950/0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 mb-8">
                            ...
                            >
                                <div className="mb-4 flex items-center justify-between">
                                    ...
                                    <div className={`px-2 py-1 rounded text-[10px] uppercase font-bold tracking-wider ${(analysis?.radioAnalysis?.clarityScore ?? 0) > 80 ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'}`}>
                        ...
                        <div className="mt-8 mx-auto max-w-md border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 rounded-lg p-6 text-center no-print">
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                                <Link href="/about" className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline uppercase tracking-wider">
