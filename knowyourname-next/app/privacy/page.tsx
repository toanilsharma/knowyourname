...
export const metadata: Metadata = {
    title: 'Privacy Policy | KnowYourName',
    description: 'How Know Your Name handles your data. Spoiler: We process everything locally in your browser.',
};
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-16 text-slate-700 dark:text-slate-300 space-y-8 animate-fade-in-up">
            ...
            <section className="space-y-4">
                ...
                <div className="bg-emerald-100 dark:bg-emerald-900/20 border border-emerald-500/20 p-4 rounded text-emerald-800 dark:text-emerald-200 text-sm">
            ...
            <section className="pt-8 border-t border-slate-200 dark:border-slate-800">
                <p className="text-sm text-slate-500">
                    If you have any questions about this Privacy Policy, you can contact us via our <Link href="/contact" className="text-blue-500 hover:underline">Contact Page</Link>.
                </p>
            </section>
        </div>
    );
