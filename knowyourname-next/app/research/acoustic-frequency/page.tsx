...
export default function AcousticFrequencyPage() {
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 pb-24">
            ...
            <ArticleHero 
                title="Acoustic Frequency & Emotion"
                subtitle="The Frequency Code"
                description="How biological laws of size and pitch influence perceived dominance in human speech and names."
                readTime="9 min read"
                gradient="from-amber-500 via-orange-500 to-red-500 hover:hue-rotate-15 transition-all duration-1000"
            />

            <ArticleProse>
                <KeyTakeaway title="The Biological Law" gradient="from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30">
                     Across the animal kingdom, <strong>low pitch = large & dominant</strong>. John Ohala's "Frequency Code" explains why deep voices (and names with back vowels like "Robert") sound authoritative, while high voices (and names with front vowels like "Timmy") sound small and non-threatening.
                </KeyTakeaway>
                ...
                <div className="not-prose mt-16 pt-8 border-t border-slate-200 dark:border-slate-800">
                    ...
                    <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                        <li className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                            <span className="font-medium text-slate-900 dark:text-white">Gussenhoven, C. (2004)</span>
                            <p className="mt-1">The Phonology of Tone and Intonation. Cambridge University Press. <a href="https://doi.org/10.1017/CBO9780511616983" className="text-blue-600 hover:underline">DOI</a></p>
                        </li>
                        <li className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                            <span className="font-medium text-slate-900 dark:text-white">Ohala, J. J. (1984)</span>
                            <p className="mt-1">An ethological perspective on common cross-language utilization of F0 of voice. <em>Phonetica</em>, 41(1), 1-16.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div className="not-prose mt-12">
                     <CitationExport
                        title="Acoustic Frequency and Emotional Valence"
                        authors={["A Sharma"]}
                        year="2026"
                        journal="Know Your Name Research Library"
                        url="https://knowyourname.co.in/research/acoustic-frequency"
                        abstract="Literature review on Ohala's Frequency Code and pitch perception."
                    />
                </div>
