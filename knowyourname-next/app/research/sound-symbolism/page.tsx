            ...
            <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose dark:prose-invert prose-slate lg:prose-lg">
                ...
                <header className="not-prose mb-12 border-b border-slate-200 dark:border-slate-800 pb-8">
                    ...
                    <div className="relative mb-8 rounded-2xl overflow-hidden shadow-xl">
                        <img 
                            src="/images/sound-symbolism.png" 
                            alt="Sound symbolism visualization showing soft and sharp forms"
                ...
                <div className="not-prose">
                     {/* Citation Export is Client Component, can use it here if I make this a client component, or I wrap it.
                         Since I want metadata, I prefer server component.
                         I'll wrap CitationExport in a client component? No, CitationExport IS a client component.
                         I can import it directly into a server component in Next.js?
                         Yes, as long as I don't pass functions as props (which I don't).
                         It should work.
                     */}
                    <CitationExport
