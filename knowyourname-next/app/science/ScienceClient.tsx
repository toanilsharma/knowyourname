...
export const ScienceClient: React.FC = () => {
        ...
        <div className={`min-h-screen transition-colors duration-1000 ${bgClass} overflow-x-hidden`}>
            ...
            <div className="max-w-4xl mx-auto px-4 py-24 text-slate-700 dark:text-slate-300 animate-fade-in-up">
                ...
                <section id="cocktail-party" className="mb-40">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="rounded-3xl overflow-hidden relative">
                            <img 
                                src="/images/science-brain.png" 
                                alt="Brain processing sound waves and name recognition"
                                className="w-full h-auto object-cover"
                            />
                            <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-sm rounded-xl px-4 py-2">
                                <div className="font-mono text-sm text-white/80">RAS Filter: Active</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div className="text-center pt-12 mb-12 border-t border-slate-200 dark:border-slate-800">
                    ...
                    <Link href="/" className="inline-block bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-transform shadow-xl">
                        Analyze My Name
                    </Link>
                </div>
