...
export const metadata: Metadata = {
    title: 'Sitemap | KnowYourName',
    description: 'Complete index of pages for Know Your Name.',
};
...
export default function SitemapPage() {
    const sections = [
        ...
        },
        {
            ...
            links: [
                { name: "The Science", path: "/science", desc: "Interactive explanation of our methodology." },
                { name: "Research Library", path: "/research", desc: "Literature reviews and academic studies." },
                { name: "Scientific Methodology", path: "/about", desc: "Detailed breakdown of algorithms." },
        ...
        },
        {
            title: "Legal & Privacy",
            links: [
                { name: "Privacy Policy", path: "/privacy", desc: "How we handle data." },
                ...
                { name: "Editorial Policy", path: "/editorial-policy", desc: "Standards and corrections." },
            ]
        },
        {
            title: "Support",
