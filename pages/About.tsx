      ...
      <section className="space-y-6">
        ...
        <div className="bg-red-50 dark:bg-red-900/10 border-l-4 border-red-500 p-6 rounded-r-lg space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-700 dark:text-slate-300">
            ...
            <li>We do <strong>not</strong> use "Numerology". Our analysis is grounded in <strong>quantitative linguistics</strong> and acoustic physics, analyzing the raw data of sound waves rather than esoteric number associations.</li>
          </ul>
